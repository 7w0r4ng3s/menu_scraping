...
> The project is a food preference recommender which uses the menu data from UCSC dining hall and labels on different foods to recommend the food I like. Since the project is currently still in development, some functionalities is waiting to be completed in the future.
